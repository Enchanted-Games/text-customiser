...
public class TextOverrideReloadListener extends SimpleJsonResourceReloadListener<TextOverrideDefinition>
//? if fabric {
...
//?}
{
    ...
    public TextOverrideReloadListener() {
        super(TextOverrideDefinition.CODEC, LISTER);
    }
